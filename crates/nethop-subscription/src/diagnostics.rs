...
impl DiagnosticCode {
    pub fn as_str(&self) -> &str {
        match self {
            ...
            Self::NodeFilteredOut => "node_filtered_out",
            Self::SourceFilteredEmpty => "source_filtered_empty",
    ...
    pub fn parse(value: &str) -> Self {
        match value {
            ...
            "node_filtered_out" => Self::NodeFilteredOut,
            "source_filtered_empty" => Self::SourceFilteredEmpty,

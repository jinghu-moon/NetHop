...
pub const RECOGNITION_ROWS: &[(&str, &[&str], &[&str], &[&str])] = &[
    ("GB", &["UK"], &["Britain", "Great Britain"], &["英國"]),
    ("US", &[], &["United States of America", "America"], &["美利坚合众国", "美國"]),
    ("CN", &[], &["Mainland China", "China Mainland"], &["中国大陆", "中國大陸", "中國"]),
    ("HK", &[], &["Hongkong"], &["香港", "香港特区", "香港特別行政區"]),
    ("TW", &[], &[], &["台灣"]),
    ("MO", &[], &["Macao"], &["澳门", "澳門"]),
    ("KR", &[], &["Republic of Korea"], &["韓國", "南韩", "南韓"]),
    ("KP", &[], &[], &["北韓"]),
    ("JP", &[], &[], &["日本国"]),
    ("RU", &[], &[], &["俄羅斯"]),
    ("VN", &[], &["Viet Nam"], &[]),
];
pub const LOCATION_ROWS: &[(&str, &[&str], &[&str], &[&str])] = &[
    ("JP", &["Tokyo", "东京", "東京", "Osaka", "大阪", "Nagoya", "名古屋", "Fukuoka", "福冈", "福岡"], &["NRT", "HND", "KIX", "ITM", "NGO", "FUK"], &["TYO", "OSA"]),
    ("HK", &["Hong Kong", "香港"], &["HKG"], &[]),
    ("TH", &["Bangkok", "曼谷", "Phuket", "普吉"], &["BKK", "DMK", "HKT"], &[]),
    ("SG", &["Singapore", "新加坡", "狮城", "獅城"], &["SIN"], &[]),
    ("TW", &["Taipei", "台北", "Kaohsiung", "高雄"], &["TPE", "TSA", "KHH"], &[]),
    ("US", &["Los Angeles", "洛杉矶", "洛杉磯", "New York", "纽约", "紐約", "Seattle", "西雅图", "San Jose", "圣何塞"], &["LAX", "JFK", "EWR", "SEA", "SJC", "SFO"], &["NYC"]),
    ("GB", &["London", "伦敦", "倫敦", "Manchester", "曼彻斯特"], &["LHR", "LGW", "MAN"], &["LON"]),
    ("DE", &["Frankfurt", "法兰克福", "法蘭克福"], &["FRA"], &[]),
    ("FR", &["Paris", "巴黎"], &["CDG", "ORY"], &["PAR"]),
    ("NL", &["Amsterdam", "阿姆斯特丹"], &["AMS"], &[]),
    ("RO", &["Bucharest", "布加勒斯特"], &["OTP"], &[]),
    ("ID", &["Jakarta", "雅加达"], &["CGK"], &[]),
    ("IN", &["Mumbai", "孟买", "Delhi", "德里", "Chennai", "金奈"], &["BOM", "DEL", "MAA"], &[]),
    ("KR", &["Seoul", "首尔", "首爾"], &["ICN", "GMP"], &["SEL"]),
    ("AU", &["Sydney", "悉尼", "Melbourne", "墨尔本"], &["SYD", "MEL"], &[]),
    ("CA", &["Toronto", "多伦多", "Vancouver", "温哥华"], &["YYZ", "YVR"], &[]),
    ("MY", &["Kuala Lumpur", "吉隆坡"], &["KUL"], &[]),
    ("PH", &["Manila", "马尼拉"], &["MNL"], &[]),
    ("AE", &["Dubai", "迪拜"], &["DXB"], &[]),
];
